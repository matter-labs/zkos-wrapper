...
impl<F: SmallField> WrappedProofSkeletonInstance<F> {
    ...
    pub(crate) fn transcript_elements_before_stage2<CS: ConstraintSystem<F>>(
        &self,
        cs: &mut CS,
    ) -> Vec<UInt32<F>> {
        let mut result = vec![];
    ...
    pub fn transcript_elements_stage2_to_stage3<CS: ConstraintSystem<F>>(
        &self,
        cs: &mut CS,
    ) -> Vec<UInt32<F>> {
        let mut result = vec![];
    ...
    pub fn transcript_elements_evaluations_at_z<CS: ConstraintSystem<F>>(
        &self,
        cs: &mut CS,
    ) -> Vec<UInt32<F>> {
        let mut result = vec![];
    ...
    pub fn transcript_elements_last_fri_step_leaf_values<CS: ConstraintSystem<F>>(
        &self,
        cs: &mut CS,
    ) -> Vec<UInt32<F>> {
        let mut result = vec![];
    ...
    pub fn transcript_elements_monomial_coefficients<CS: ConstraintSystem<F>>(
        &self,
        cs: &mut CS,
    ) -> Vec<UInt32<F>> {
        let mut result = vec![];
